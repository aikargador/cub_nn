...
{
	// printf("%d\n", (int)(table->plr.pos.x + table->plr.dir.x * table->plr.mv_spd);
	// printf("%d\n", (int)(table->plr.pos.x + table->plr.dir.x * table->plr.mv_spd);
	if (table->parse->map[(int)(table->plr.pos.y)][(int)(table->plr.pos.x + table->plr.dir.x * table->plr.mv_spd)] != '1')
		table->plr.pos.x += table->plr.dir.x * table->plr.mv_spd;
	if (table->parse->map[(int)(table->plr.pos.y + table->plr.dir.y * table->plr.mv_spd)][(int)(table->plr.pos.x)] != '1')
...
{
	if (table->parse->map[(int)(table->plr.pos.y - table->plr.dir.x * table->plr.mv_spd)][(int)(table->plr.pos.x)] != '1')
		table->plr.pos.y -= table->plr.dir.x * table->plr.mv_spd;
	if (table->parse->map[(int)(table->plr.pos.y)][(int)(table->plr.pos.x + table->plr.dir.y * table->plr.mv_spd)] != '1')
